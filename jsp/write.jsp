              ...
              <form action="writeAction.jsp" method="post">
                <table>
                  <tr class="tr">
                    ...
                    <td style="width: 80%;"><input style="width: 100%;" type="text" name="bbsTitle"></td>
                  </tr>
                  <tr class="tr">
                    <th style="width: 20%;">작성자</th>
                    <td style="width: 80%;"><input style="width: 100%;" type="text" value="<%=userID %>" name="userID" readonly ></td>
                  </tr>
                  <tr class="tr" style="height: 330px;">
                    <th style="width: 20%;">내용</th>
                    <td style="width: 80%;"><textarea style="width: 100%; height: 300px" type="text" name="bbsContent"></textarea></td>
                  </tr>
                </table>
                <br>
                <button type="submit" class="btn btn-dark" id="btn-write">글작성</button>
                </form>
            </div>
          </div>
