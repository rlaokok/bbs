...
<nav class="navbar navbar-default">
	...
	<div class="container">
            <div id="container_70pro">
              <br>
              <div style="text-align: center; font-size: 1.5em;"><b>LOGIN</b></div><br>
                    <form action="loginAction.jsp" method="POST">
                        ...
                        <div class="form-floating">
                            <input type="password" class="form-control" id="floatingPassword" placeholder="패스워드" name="userPassword">
                           
                        </div>
                        <br>
                        <div class="d-grid gap-2">
                            <button class="btn btn-dark" type="submit" style="width:100%">로그인</button>
                        </div>
                        <br>
                        <div class="row">
                          <div class="col">
                            <a href="join.jsp" class="a-tag">회원가입</a>
                          </div><br>
                          <div class="col">
                            <a href="findID.jsp" class="a-tag">아이디 찾기</a>
                          </div>
                        </div>
                        <br>
